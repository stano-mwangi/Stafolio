...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.bunny.net/css?family=inter:400,500,600&family=plus-jakarta-sans:600,700" rel="stylesheet" />
        <style>
...
class="rounded-2xl shadow-xl border border-white/20"
alt="Profile Image">
</div>
...
<p class="text-gray-300">
Laravel, PHP, REST APIs, database design and backend architecture.
</p>
</div>
...
<p class="text-gray-300">
Network scanning, vulnerability analysis, penetration testing tools and security labs.
</p>
</div>
...
<span class="px-4 py-2 bg-indigo-500 rounded-lg">Kali Linux</span>
<span class="px-4 py-2 bg-indigo-500 rounded-lg">Python</span>
...
Ask my AI assistant anything about my projects, experience or skills.
</p>

<a href="/"
class="px-8 py-3 bg-indigo-500 hover:bg-indigo-600 rounded-lg font-semibold transition">
