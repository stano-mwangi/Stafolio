...
<div x-show="chatOpen" x-transition class="w-full max-w-2xl mx-auto">
    ...
    <div class="border border-[#d6c4a9] rounded-2xl p-5 lg:p-6 shadow-md bg-[#fffdf9]">

        <h2 class="text-2xl font-semibold text-[#321f63] mb-3">
            Ask My AI Agent
        </h2>
...
<button 
    ...
    class="mt-4 text-sm text-[#4f3a74] font-medium underline hover:text-[#2f165f]">
    ← Back
</button>
</div>
</main>
